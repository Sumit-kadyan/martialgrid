...
export default function Home() {
  ...
  useEffect(() => {
    // This effect now ONLY handles the onboarding redirect logic.
    // The AppHeader component handles its own auth state for UI purposes.
    const {
      data: { subscription },
      ...
      if (session) {
        ...
        // If a profile exists and onboarding is not complete, redirect.
        if (profile && !profile.onboarding_completed) {
          router.push('/onboarding')
        // If profile doesn't exist at all, they also need to onboard.
        } else if (!profile) {
          router.push('/onboarding')
        }
      }
